...
## 5. Permanent Bug Fixes & Pre-Approval
...
## 7. Frontend & Design System Guidelines
...
## 8. Project Knowledge Base (`context.md`)
...
> Don't commit. Hand the user a commit message instead.

- Do **not** run `git commit` or `git push`.
- When a prompt, feature, or task is complete, provide a ready-to-use commit message (Conventional Commits format) for the user to run manually.
